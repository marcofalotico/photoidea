...
// Metadati dei post del blog.
// SLUG: solo l'ultima parte (es. "matrimonio-rossella-simone-tenuta-carretta-piobesi-alba").
// Rotta: "/blog/:slug".

export const blogPosts = [
  {
    id: "rossella-simone-tenuta-carretta-piobesi-alba",
    title:
      "Un matrimonio da favola a Piobesi d’Alba: Rossella e Simone alla Tenuta Carretta",
...
Dalla cerimonia emozionante all’aperto, al rinfresco elegante e ai balli sfrenati che hanno chiuso la serata, ogni dettaglio è stato perfetto. Qui sotto trovate alcuni scatti che catturano i momenti più belli di questa giornata speciale, dai sorrisi degli sposi agli abbracci degli amici e parenti.
  ...
  {
    id: "elisa-alessandro-podere-la-piazza-colline-astigiane",
    title:
  ...
  {
    id: "accademia-scienze-torino-dolce-stil-novo-venaria",
    title:
